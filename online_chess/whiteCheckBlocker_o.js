...
import {renderboard,gameState,WhiteCapturedPiece,gamemove} from "./mainChess_o.js"
                        ...
                        threadblocker.onclick = () =>{
                           ...
                           if(Attacker){
                             ...
                             Attacker.onclick = () =>{
                              ...
                              let captureobj = 
                              {code : gamecode,mycolor : color,color : 'white',captured : capturepiece};
                    ...
                    if(!ispinned){
                      ...
                      threadplace.classList.add('AttackHighlight');
                       threadplace.onclick = () =>{
                         ...
                         let captureobj = 
                         {code : gamecode,mycolor : color,color : 'white',captured : capturedpiece};
                         socket.emit('capture',captureobj);
